              ...
              children: [
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: product.isFavourite ? kPrimaryColor.withOpacity(0.2) : kSecondaryColor.withOpacity(0.1),
                      shape: BoxShape.circle,
                    ),
                    child: SvgPicture.asset("assets/icons/Heart Icon_2.svg" , color: product.isFavourite ? Color(0xFFF4848) : Color(0xFFDBDEE4),),
                  ),
                ),
              ],
            )
