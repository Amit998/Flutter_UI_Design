...
Color primaryColor = Color(0xff203cc3b);



class DataSource {
  static String quote = 'You can install multiple versions of Android Studio side-by-side, so if a bug in the preview build blocks you, you can keep working on the same project from the stable version.';
