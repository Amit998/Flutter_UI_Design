...
class _CreateAccountState extends State<CreateAccount> {
  ...
  submit() {
    ...
    if (form.validate()) {
      form.save();
      SnackBar snackbar = SnackBar(content: Text("Wellcome $username"));
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      key: _scafoldKey,
      appBar: header(context, titleText: "Be The Yaari Memenber",removeBackButton: true),
      body: ListView(
        children: [
          Container(
            child: Column(
